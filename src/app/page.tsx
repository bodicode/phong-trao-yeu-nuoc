...
type Movement = {
  ...
  image?: string; // static asset path if available
  references?: string[];
};
...
export default function HomePage() {
  ...
  const movements: Movement[] = [
    ...
    },
    {
      ...
      legacy: "Biểu tượng khí tiết sĩ phu; nguồn cảm hứng về tự cường quân sự.",
    },
    {
      year: "1886 - 1887",
    ...
    },
    {
      ...
      impact: "Chuyển hóa ý thức quần chúng; đặt vấn đề dân sinh – dân quyền.",
    },
    {
      year: "1912 - 1916",
            ...
            filteredMovements.map((item, index) => (
              ...
              >
                <div className="relative">
                  ...
                  {/* Card */}
                  <div
                    className={`ml-12 bg-white p-0.5 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-transparent group-hover:border-orange-300`}
                  >
